...
# instalei o pip, pandas e openai


def ler_arquivo(nome="SDW2023.csv"):
    arquivo_csv = open(nome, mode='r')
...
def gerar_mensagem(user):
    ...
    completion = openai.ChatCompletion.create(
        ...
        {
            "role": "system",
            "content": f"Você é um especialista em markting bancário e fará uma mensagem direcionada a um cliente que será solicitada."
        },
...
if __name__ == "__main__":
    ...
    for indice, user in enumerate(users):
        ...
        arquivo_csv.write(f"Resposta do usuário {user['nome']}:\n {mensagem}\n\n")
        print(mensagem)
        time.sleep(21) # ("Esperando 21 segundos para não exceder o limite de requisições da API")
